...
const licensePlates = ['ITC123', 'BOF456', 'MII789']
...
for (let i = 0; i < charactersArray.length; i++) {
  ...
  switch (character) {
    ...
    case 'c':
      posizione = 3;
      break;
    // Continua con gli altri caratteri dell'alfabeto italiano...
    case 'z':
      posizione = 21;
      break;
    default:
      posizione = -1; // Carattere non presente nell'alfabeto italiano
  }

  alfabetoItaliano.push(posizione);
}
